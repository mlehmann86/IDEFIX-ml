...
class Fluid {
 public:
  ...
  // Enroll user-defined thermal diffusivity function
  void EnrollUserDefThermalDiffusivity(DiffusivityFunc f) {
    this->thermalDiffusion->EnrollThermalDiffusivity(f);
  }
